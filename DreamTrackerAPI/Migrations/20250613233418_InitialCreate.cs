        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dreams_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dreams_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DreamTags", x => new { x.DreamId, x.TagId });
                    table.ForeignKey(
                        name: "FK_DreamTags_Dreams_DreamId",
                        column: x => x.DreamId,
                        principalTable: "Dreams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DreamTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dreams_CategoryId",
                table: "Dreams",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Dreams_UserProfileId",
                table: "Dreams",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_DreamTags_TagId",
                table: "DreamTags",
                column: "TagId");

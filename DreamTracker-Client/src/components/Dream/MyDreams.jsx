...
useEffect(() => {
  ...
  if (loading) {
    return <p className="text-center mt-12 text-lg text-gray-600">Loading your dreams...</p>
  }
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 py-8">
      ...
      {dreams.length === 0 ? (
        <p className="text-gray-500 italic">You haven’t recorded any dreams yet.</p>
      ) : (
        <DreamList dreams={dreams} onDelete={handleDelete} showDelete />
      )}
    </section>
  )
}
